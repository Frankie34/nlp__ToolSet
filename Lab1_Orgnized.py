...
# print(wordlists.words('TALKSHOW.txt'))

# get text length #

text = wordlists.words('TALKSHOW.txt')
text2 = wordlists.words('SPEECH.txt')
text3 = wordlists.words('FICTION.txt')
'''
print(len(text))
...
print(content_fraction(wordlists.words('TALKSHOW.txt')))
'''
'''
